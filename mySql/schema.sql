...
--
-- Table structure for table `setTemp`
--

DROP TABLE IF EXISTS `setTemp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `setTemp` (
  `setTemp` int(11) DEFAULT NULL,
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `smoker` (
  `smokerTemp` int(11) DEFAULT NULL,
  `meatTemp` int(11) DEFAULT NULL,
  `setTemp` int(11) DEFAULT NULL,
  `fanSpeed` int(11) DEFAULT NULL,
  `timeStamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1903115 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-10-18  2:22:06
